...
<template>
    <div class="homepage-hero-module">
        <div class="video-container">
                    ...
                    <el-form ref="form" :model="form" :rules="rules" size="normal">
                        ...
                        <el-form-item>
                            <div style="display: flex">
                                <el-input v-model="form.validCode" placeholder="请输入验证码" prefix-icon="el-icon-key"
            ...
            <video autoplay="" class="fillWidth" loop="" muted="" playsinline="">
                <source src='../assets/css/sea.mp4' type="video/mp4">
            </video>
...
//import '../../public/static/login.js'
//import '../../public/static/login.css'
...
export default {
    ...
    data() {
        return {
            ...
            validCode: '',
            bg: {
                backgroundImage: "url(" + require("@/../public/static/loginback01.jpg") + ")",
