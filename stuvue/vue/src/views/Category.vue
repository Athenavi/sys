    ...
    <div style="padding: 10px">
        ...
        >
            ...
            <el-table-column label="操作">
                <template #default="scope">
                    ...
                    <el-popconfirm v-if="user.role === 1" title="确定删除吗？" @confirm="handleDelete(scope.row.id)">
                        <template #reference>
        ...
        <el-card style="margin: 10px 0; width: 50%">
            <div class="custom-tree-container">
                <el-tree :data="tableData" :default-checked-keys="checkedList" :default-expanded-keys="[1, 2]"
                         :props="defaultProps"
                         node-key="id"
                         show-checkbox
        ...
        <el-card style="width: 50%">
            <el-cascader v-model="casdata" :options="options" clearable @change="changeCas"></el-cascader>
        </el-card>
